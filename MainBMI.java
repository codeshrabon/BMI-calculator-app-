...
public class MainBMI {
    ...
    public static void main(String[] args) {
        ...
        switch (bmiSystem.toUpperCase()) {
            ...
            case "IMPERIAL":
                // Please invoke the obtainWeight() method of the UserInput class and assign it
                // to the variable weight
                weight = userInput.obtainWeight(bmiSystem);
                // Please invoke the obtainHeight() method of the UserInput class and assign it
        ...
        // Please invoke the getBMICategory() method of the BMICalculator class and
        // assign the result to the bmiCategory variable
